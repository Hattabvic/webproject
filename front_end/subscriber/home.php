        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">We love you <?= $user->first_name ?></h1>
                    <h2 class="fw-light">Enjoy our blog</h2>
                    ...
                    <div class="col-8 offset-2 border border-secondary-subtle rounded mb-4 shadow p-2">
                        <div class="panel panel-white  rounded">
                            <div class="post-heading  m-4">
                                <div class="  ">
                                    <img style="width:50px ; height: 50px; border-radius:50px;" src="<?php if (!empty($posts["user_image"]))
