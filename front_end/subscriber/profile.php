            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="action">
                            ...
                            ?>
                                <a style="color:#5a23c8" role="button" href="handle_like.php ?post_id=<?= $post["id"] ?> & like=no" class="btn btn-primary btn-lg btn-floating">
                            ...
                            ?>
                                <a style="color:black" role="button" href="handle_like.php?post_id=<?= $post["id"] ?> & like=yes" class="btn btn-primary btn-lg btn-floating">
                        ...
                        <div class="action">
                            <a role="button" href="All_like.php ?post_id=<?= $post["id"] ?>" class="btn btn-primary btn-lg btn-floating">
