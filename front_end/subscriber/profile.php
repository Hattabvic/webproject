        ...
        <div class="row py-5 px-4  w-full">
            <div class="col-12 ">
                ...
                <div class="bg-white shadow rounded overflow-hidden">
                    ...
                    <hr>
                    <div class="py-4 px-2">
                        <div class="p-4 bg-light  rounded shadow-sm m-4">
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="d-flex flex-row align-items-center">
                                                                        <img style="border-radius: 50%;"
                                                                            src="<?= empty($comment['image']) ? 'https://t4.ftcdn.net/jpg/02/34/57/59/240_F_234575931_hDnNJiXNgTzJO4iDDZjhneWKF25o7O2f.jpg' : $comment['image']; ?>"
